...
import com.example.appcuathocattoc.Adapter.MySalonAdapter;
import com.example.appcuathocattoc.Common.Common;
import com.example.appcuathocattoc.Common.SpacesItemDecoration;
import com.example.appcuathocattoc.Interface.IBranchLoadListener;
import com.example.appcuathocattoc.Interface.IGetBarberListener;
import com.example.appcuathocattoc.Interface.IOnLoadCountSalon;
...
public class SalonListActivity extends AppCompatActivity implements IOnLoadCountSalon, IBranchLoadListener, IGetBarberListener, IUserLoginRememberListener {
    ...
    public void onUserLoginSuccess(String user) {
        ...
        Paper.book().write(Common.DISTRICT_KEY, Common.district_name);
