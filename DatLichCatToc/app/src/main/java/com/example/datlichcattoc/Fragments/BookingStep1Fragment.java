...
import com.example.datlichcattoc.Adapter.MySalonAdapter;
import com.example.datlichcattoc.Common.Common;
import com.example.datlichcattoc.Common.SpacesItemDecoration;
import com.example.datlichcattoc.Interface.IAllSalonLoadListener;
import com.example.datlichcattoc.Interface.IBranchLoadListener;
...
public class BookingStep1Fragment extends Fragment implements IAllSalonLoadListener, IBranchLoadListener {
    ...
    public void onAllSalonLoadSuccess(List<String> areaNameList) {
        ...
        spinner.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(MaterialSpinner view, int position, long id, Object item) {
                if (position > 0)
                {
                    loadBranchOfDistrict(item.toString());
                }
                else
                {
    ...
    private void loadBranchOfDistrict(String districtName) {
